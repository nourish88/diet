      ...
      <View className="p-4">
        ...
        <Card className="mb-4">
          ...
          <View className="space-y-2">
            <Text className="text-secondary-700">
              <Text className="font-medium">Danışan:</Text> {diet.client.name}{" "}
              {diet.client.surname}
            </Text>
            <Text className="text-secondary-700">
        ...
        <Card className="mb-4">
          ...
          <View className="space-y-4">
            {diet.oguns.map((ogun) => (
              <View key={ogun.id} className="bg-secondary-50 p-3 rounded-lg">
                <View className="flex-row items-center mb-2">
                  <Clock className="h-4 w-4 text-primary-600 mr-2" />
                  <Text className="font-medium text-secondary-900">
                    {ogun.name}
                  </Text>
                  <Text className="text-primary-600 font-medium ml-auto">
                ...
                <View className="space-y-1">
                  {ogun.items.map((item) => (
                    <Text key={item.id} className="text-secondary-600 text-sm">
