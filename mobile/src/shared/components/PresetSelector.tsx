    ...
    >
      <SafeAreaView style={styles.container}>
        ...
        {isLoading ? (
          ...
          <FlatList
            data={[
              ...(autoPresets.length > 0 ? [{ type: "auto", presets: autoPresets }] : []),
              ...(manualPresets.length > 0 ? [{ type: "manual", presets: manualPresets }] : []),
            ]}
            ...
            renderItem={({ item }) => (
              <View style={styles.section}>
                ...
                {item.type === "manual" && (
                  <View style={styles.sectionHeader}>
                    <Text style={styles.sectionTitle}>📋 Manuel Preset'ler</Text>
                  </View>
                )}
