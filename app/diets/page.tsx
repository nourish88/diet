      ...
      <div className="mb-6">
        <div className="relative">
          ...
          <input
            ...
            placeholder="Beslenme programı veya müşteri ara..."
            disabled
          />
        </div>
        <p className="text-xs text-gray-500 mt-1">
          Arama özelliği yakında gelecek
        </p>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="bg-white rounded-lg shadow-sm border-2 border-purple-700 overflow-hidden">
          <div className="bg-gradient-to-r from-indigo-600 to-purple-700 px-6 py-4 text-white">
            <h2 className="text-lg font-medium">Tüm Beslenme Programları</h2>
            <p className="text-sm text-blue-100 mt-1">
              Toplam {diets.length} program
            </p>
          </div>
